			...
			<form method="post" action="ajouterRecette">
				<fieldset>
					...
					<label for="difficulteRecette">Difficulté <span
						class="requis">*</span></label> <input type="text" id="difficulteRecette"
						name="difficulteRecette"
						value="<c:out value="${param.difficulteRecette}"/>" size="20"
						maxlength="20" /> <span class="erreur">${erreurs['difficulteRecette']}</span>
					<br />
					...
					<br /> <span class="erreur">${erreurs['ingredientsRecette']}</span>
					<br />
					...
					<br /> <span class="erreur">${erreurs['texteRecette']}</span> <br />
