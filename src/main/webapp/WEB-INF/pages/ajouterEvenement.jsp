			...
			<form method="post" action="ajouterEvenement">
				<fieldset>
					...
					<input type="text" id="titreEvenement" name="titreEvenement"
						value="<c:out value="${param.titreEvenement}"/>" size="20"
						maxlength="50" /> <br /> <span class="erreur">${erreurs['titreEvenement']}</span><br />

					<!-- Ajout de la date -->
					<label for="dateEvenement">Date</label> <input type="date"
						id="dateEvenement" name="dateEvenement"
						value="<c:out value="${param.dateEvenement}"/>" /> <br />
					<br />

					<!-- Ajout de la description -->
					<label for="detailEvenement">Description <span
						class="requis">*</span></label>
					<textarea name="detailEvenement" id="detailEvenement"
						value="<c:out value="${param.detailEvenement}"/>" rows="5"
						cols="50">
					</textarea>
					<br /> <span class="erreur">${erreurs['detailEvenement']}</span> <br />

					<!-- Ajout du lieu -->
					<label for="lieuEvenement">Lieu <span class="requis">*</span></label>
					<input type="text" id="lieuEvenement" name="lieuEvenement"
						value="<c:out value="${param.lieuEvenement}"/>" size="65"
						maxlength="100" /> <br /> <span class="erreur">${erreurs['lieuEvenement']}</span>
					<br />
